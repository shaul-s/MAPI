...
ROOT = r'C:\Users\Saul\PycharmProjects\just_for_fun\MapiX\data\shp2coco_tst'
img_path = 'img'
shp_path = 'shp'
...
def from_mask_to_coco(root, MARK, IMAGE, ANNOTATION):
    ...
    if os.path.exists(ROOT_DIR):
        ...
        with open('{}/instances_trees_{}2021.json'.format(ROOT_DIR, MARK), 'w') as output_json_file:
...
def main():
    ...
    # from_mask_to_coco(ROOT_DIR, 'train', "trees_2021", "mask")
    # from_mask_to_coco(ROOT_DIR, 'eval', "trees_2021", "mask")
    # from_mask_to_coco(ROOT_DIR, 'test', "trees_2021", "mask")
